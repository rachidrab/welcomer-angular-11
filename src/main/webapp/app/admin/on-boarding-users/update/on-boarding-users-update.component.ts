...
@Component({
  selector: 'jhi-on-boarding-users-update',
  templateUrl: './on-boarding-users-update.component.html',
  styleUrls: ['./on-boarding-users-update.component.scss']
})
export class OnBoardingUsersUpdateComponent implements OnInit {
