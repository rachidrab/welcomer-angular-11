...
@Component({
  selector: 'jhi-off-boarding-users-update',
  templateUrl: './off-boarding-users-update.component.html',
  styleUrls: ['./off-boarding-users-update.component.scss']
})
export class OffBoardingUsersUpdateComponent implements OnInit {
