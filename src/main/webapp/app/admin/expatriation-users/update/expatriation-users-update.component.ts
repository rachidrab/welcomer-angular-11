...
@Component({
  selector: 'jhi-expatriation-users-update',
  templateUrl: './expatriation-users-update.component.html',
  styleUrls: ['./expatriation-users-update.component.scss']
})
export class ExpatriationUsersUpdateComponent implements OnInit {
